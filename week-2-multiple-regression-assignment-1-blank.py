...
train_data['log_sqft_living']=train_data['sqft_living'].apply(lambda x : log(float(x)))
test_data['log_sqft_living']=test_data['sqft_living'].apply(lambda x : log(float(x)))
...
sum(test_data['bedrooms_squared'])/len(test_data['bedrooms_squared'])


# In[13]:

sum(test_data['bed_bath_rooms'])/len(test_data['bed_bath_rooms'])


# In[14]:

sum(test_data['log_sqft_living'])/len(test_data['log_sqft_living'])


# In[15]:

sum(test_data['lat_plus_long'])/len(test_data['lat_plus_long'])
